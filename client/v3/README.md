...
```bash
go get yunli.com/jobpool/client/v2
```
...
```
go get yunli.com/jobpool/client/v2@v3.5.0-pre
```
...
The [namespace](https://godoc.org/yunli.com/jobpool/client/v2/namespace) package provides `clientv3` interface wrappers to transparently isolate client requests to a user-defined prefix.
...
More code [examples](https://github.com/etcd-io/etcd/tree/main/tests/integration/clientv3/examples) can be found at [GoDoc](https://pkg.go.dev/yunli.com/jobpool/client/v2).
