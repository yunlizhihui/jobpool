...
running(leaking) after all tests.
	...
	import "yunli.com/jobpool/client/pkg/v2/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "yunli.com/jobpool/client/pkg/v2/testutil.interestingGoroutines") ||
			strings.Contains(stack, "yunli.com/jobpool/client/pkg/v2/logutil.(*MergeLogger).outputLoop") ||
