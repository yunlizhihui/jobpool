...
import (
	...
	etcdservergw "yunli.com/jobpool/api/v2/etcdserverpb/gw"
	...
	"yunli.com/jobpool/server/v2/etcdserver/api/v3client"
	"yunli.com/jobpool/server/v2/etcdserver/api/v3election"
	"yunli.com/jobpool/server/v2/etcdserver/api/v3election/v3electionpb"
	v3electiongw "yunli.com/jobpool/server/v2/etcdserver/api/v3election/v3electionpb/gw"
	"yunli.com/jobpool/server/v2/etcdserver/api/v3lock"
	"yunli.com/jobpool/server/v2/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "yunli.com/jobpool/server/v2/etcdserver/api/v3lock/v3lockpb/gw"
...
func (sctx *serveCtx) registerGateway(dial func(ctx context.Context) (*grpc.ClientConn, error)) (*gw.ServeMux, error) {
	...
	handlers := []registerHandlerFunc{
		...
		etcdservergw.RegisterScheduleHandler,
