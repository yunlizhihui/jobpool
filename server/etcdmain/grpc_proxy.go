...
import (
	...
	"yunli.com/jobpool/client/v2/leasing"
	"yunli.com/jobpool/client/v2/namespace"
	"yunli.com/jobpool/client/v2/ordering"
	...
	"yunli.com/jobpool/server/v2/proxy/grpcproxy"
...
func newGRPCProxyServer(lg *zap.Logger, client *clientv3.Client) *grpc.Server {
	...
	// schedule 业务
	schedulep := grpcproxy.NewScheduleProxy(client)
	...
	// schedule 相关业务
	pb.RegisterScheduleServer(server, schedulep)
