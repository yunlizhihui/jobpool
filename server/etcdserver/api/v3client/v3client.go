...
import (
	...
	"yunli.com/jobpool/server/v2/proxy/grpcproxy/adapter"
)
...
func New(s *etcdserver.EtcdServer) *clientv3.Client {
	...
	// 增加业务逻辑相关
	sc := adapter.ScheduleServerToScheduleClient(v3rpc.NewScheduleServer(s))
	c.Schedule = clientv3.NewScheduleFromScheduleClient(sc, c)
	return c
}
