...
import (
	...
	"yunli.com/jobpool/server/v2/mock/mockstorage"
	"yunli.com/jobpool/server/v2/mock/mockstore"
	"yunli.com/jobpool/server/v2/mock/mockwait"
...
func TestTimeDuration(t *testing.T) {
	...
	twoMinuteAgo := time.Now().Add(-2 * time.Minute)
	fmt.Println(tenMinuteAgo.UnixMicro())
	fmt.Println(twoMinuteAgo.UnixMicro())
	if tenMinuteAgo.UnixMicro() < twoMinuteAgo.UnixMicro() {
		fmt.Println("ok")
	}
}

func TestCaseTimmer(t *testing.T) {
	tm := time.Second * 2
