...
replace (
	...
	yunli.com/jobpool/jobpoolctl/v2 => ./jobpoolctl
...
require (
	...
	yunli.com/jobpool/jobpoolctl/v2 v2.0.0-00010101000000-000000000000
	yunli.com/jobpool/pkg/v2 v2.0.0-00010101000000-000000000000
	yunli.com/jobpool/server/v2 v2.0.0-00010101000000-000000000000
)
