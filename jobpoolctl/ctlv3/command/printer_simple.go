...
func (s *simplePrinter) PlanDetail(r pb.SchedulePlanDetailResponse) {
	fmt.Printf("%s\n", r.Data)
}
...
func (s *simplePrinter) PlanList(r pb.SchedulePlanListResponse) {
	for _, plan := range r.Data {
		fmt.Printf("%s\n", plan)
	}
}

func (s *simplePrinter) JobList(r pb.ScheduleJobListResponse) {
	for _, job := range r.Data {
		fmt.Printf("%s\n", job)
	}
}

func (s *simplePrinter) JobDetail(r pb.ScheduleJobDetailResponse) {
	fmt.Printf("%s\n", r.Data)
}

func (s *simplePrinter) JobStatusUpdate(r pb.ScheduleJobStatusUpdateResponse) {
	fmt.Printf("%s\n", r.Data)
}

func (s *simplePrinter) NamespaceList(r pb.ScheduleNameSpaceListResponse) {
	for _, ns := range r.Data {
		fmt.Printf("%s\n", ns)
	}
}

func (s *simplePrinter) NamespaceAdd(_ string, r pb.ScheduleNameSpaceAddResponse) {
	fmt.Printf("%s\n", "success")
}

func (s *simplePrinter) NamespaceDelete(_ string, response pb.ScheduleNameSpaceDeleteResponse) {
	fmt.Printf("%s\n", "success")
}

func (s *simplePrinter) EvalList(r pb.ScheduleEvalListResponse) {
	for _, ns := range r.Data {
		fmt.Printf("%s\n", ns)
	}
}

func (s *simplePrinter) EvalDetail(r pb.ScheduleEvalDetailResponse) {
	fmt.Printf("%s\n", r.Data)
}

func (s *simplePrinter) AllocationList(r pb.ScheduleAllocationListResponse) {
	for _, ns := range r.Data {
		fmt.Printf("%s\n", ns)
	}
}

func (s *simplePrinter) AllocationDetail(r pb.ScheduleAllocationDetailResponse) {
	fmt.Printf("%s\n", r.Data)
}
