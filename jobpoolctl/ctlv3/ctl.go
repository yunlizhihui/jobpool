...
import (
	...
	"yunli.com/jobpool/jobpoolctl/v2/ctlv3/command"
...
const (
	cliName        = "jobpoolctl"
	cliDescription = "A simple command line client for jobpool."
